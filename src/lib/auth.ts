...
export const authOptions: NextAuthOptions = {
  providers: [
    SpotifyProvider({
      ...
      authorization: "https://accounts.spotify.com/authorize?scope=user-read-email,user-read-private,user-top-read,playlist-modify-public,playlist-modify-private&show_dialog=true",
    }),
    CredentialsProvider({
